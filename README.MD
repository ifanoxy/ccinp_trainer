...
> Une solution complète (Script d'extraction LaTeX + Application de bureau) conçue pour révolutionner la préparation aux oraux de mathématiques des concours CCINP (Filières MP / MPI).
...
**La solution CCINP Trainer Pro se divise en deux parties :**
...
### Instructions
1. Placez le fichier source officiel `banque_orale.tex` à la racine de ce dossier (au même niveau que `split_latex.js`).
